...
if (("5. Densidad de Poblacion" %in% Indicadores_a_calcular) || grepl("^6", Indicadores_a_calcular)) {
  ...
  print("No se han introducido las capas necesarias para calcular el índice 5. Densidad de población o cualquier otro índice 6. Proximidad a servicios básicos")
}
